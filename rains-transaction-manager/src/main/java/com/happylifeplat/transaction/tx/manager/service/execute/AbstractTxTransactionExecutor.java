...
//import com.happylifeplat.transaction.tx.manager.service.NotifyManagerService;
...
//
//    private static final Map<String,Set<CallbackListener>> callBackListeners = new ConcurrentHashMap<>();
//
//
//
//
...
//    private NotifyManagerService notifyManagerService;
//
//    protected void setTxManagerService(TxManagerService txManagerService) {
//        this.txManagerService = txManagerService;
//    }
//    protected void setNotifyManagerService(NotifyManagerService notifyManagerService) {
...
//                final Map<String, List<TxTransactionItem>> listMap = filterData(txTransactionItems);
...
//        }
//
////       boolean isAllCommit= notifyManagerService.notifyCommit(txGroupId,listMap);
////        if(!isAllCommit){
////            notifyManagerService.notifyRollBack(txGroupId,listMap);
////        }
//
//        /*
//             获取当前连接的channel  为什么？
...
//    }
//
//    private Map<String, List<TxTransactionItem>> filterData(List<TxTransactionItem> txTransactionItems) {
...
//            return null;
//        }
//        return collect.stream().collect(Collectors.groupingBy(m->m.getTmDomain()));
//    }
//
//
//
