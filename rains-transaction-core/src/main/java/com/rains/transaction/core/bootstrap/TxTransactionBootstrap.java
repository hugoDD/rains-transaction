...
/*
 * 文 件 名:  TxTransactionBootstrap.java
 * 版    权:  Copyright (c) 2018 com.rains.hugosz
 * 描    述:  初始化分布式事务
 * 创 建 人:  hugosz
 * 创建时间:  2018/11/6
 */
public class TxTransactionBootstrap  implements ApplicationContextInitializer<ConfigurableApplicationContext> {
...
//    }
    ...
    public void initialize(ConfigurableApplicationContext configurableApplicationContext) {
        SpringBeanUtils.getInstance().setCfgContext(configurableApplicationContext);
