...
package com.rains.transaction.tx.dubbo.sample.consume.configuration;
...
public class SwaggerConfig {
    ...
    private static final String SWAGGER_SCAN_BASE_PACKAGE = "com.rains.transaction.tx.dubbo.sample.consume.controller";
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("")
                .version(VERSION)
                .contact(new Contact("hugoDD", "", "280555235@qq.com"))
                .build();
    }
